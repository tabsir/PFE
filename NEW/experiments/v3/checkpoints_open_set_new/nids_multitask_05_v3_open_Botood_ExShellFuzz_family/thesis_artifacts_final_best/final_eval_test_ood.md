...
- Recall 95% bootstrap CI: [0.000000, 0.000000] (valid bootstrap samples=1000)
- F1 95% bootstrap CI: [0.000000, 0.000000] (valid bootstrap samples=1000)
...
- Reconstruction-only novelty PR-AUC: 0.990029
- Reconstruction-only novelty recall: 0.000924
- Reconstruction-only novelty PR-AUC 95% bootstrap CI: [0.986982, 0.992691] (valid bootstrap samples=1000)
