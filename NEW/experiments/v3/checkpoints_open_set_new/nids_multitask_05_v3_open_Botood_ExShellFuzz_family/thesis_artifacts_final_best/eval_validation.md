...
- Recall 95% bootstrap CI: [0.895283, 0.904362] (valid bootstrap samples=1000)
- F1 95% bootstrap CI: [0.944748, 0.949780] (valid bootstrap samples=1000)
...
- F1 95% bootstrap CI: [0.850000, 0.911698] (valid bootstrap samples=1000)
...
- Reconstruction-only novelty PR-AUC: 0.004189
- Reconstruction-only novelty recall: 0.796117
- Reconstruction-only novelty PR-AUC 95% bootstrap CI: [0.002521, 0.009585] (valid bootstrap samples=1000)
